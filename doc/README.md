...
| [options.flags] | <code>Array.&lt;String&gt;</code> |  | An optional space-separated list of feature flags that your application has early access to. Flags are colon separated for any suboptions they may have |
